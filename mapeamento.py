from sqlalchemy import Column, Date, ForeignKeyConstraint, Index, Integer, PrimaryKeyConstraint, SmallInteger, String, Table, Text, UniqueConstraint
...
class Games(Base):
    ...
    __table_args__ = (
        ...
        Index('release_game_date', 'release_date'),
        {'schema': 'public'}
    )
...
t_game_gamemode = Table(
    ...
    Index('idx_game_game_mode', 'id_game', 'id_game_mode'),
    schema='public'
)
...
t_game_genre = Table(
    ...
    Index('idx_game_genres', 'id_game', 'id_genre'),
    schema='public'
)
...
t_game_plataform = Table(
    ...
    Index('idx_game_plataform', 'id_game', 'id_plataform'),
    schema='public'
)
